...
var ClassyLeaves = function(settings) {
    ...
    this.add = function(leaves) {
        ...
        for (var z = 0; z < leaves; z++) {
            ...
            $('body').append('<img id="leaf' + this.numLeaves + '" class="ClassyLeaf x' + size + '" src="' + this.settings.folder + num + '.png" style="background:none" />');
    ...
    this._multiply = function(id) {
        ...
        for (var i = 0; i <= this.settings.multiply; i++) {
            ...
            $('body').append('<img id="leaf' + this.numLeaves + '" class="ClassyLeaf ' + cls + '" src="' + this.settings.folder + num + '.png" style="background:none" />');
            leaf = $("#leaf" + this.numLeaves);
            leaf.css({
                top: x + 'px',
                left: y + 'px'
