...
var App = function () {
    ...
    var handleHorizontalMenu = function () {
        ...
        $('.header').on('click', '.hor-menu .search-form .btn', function (e) {
                ...
                window.location.href = "http://"+window.location.host+"/tools/search.html?type=and&results=20&url=all&query="+query;
                e.preventDefault();
            });
...
*/
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            var el = jQuery(el); 
            el.block({
                    message: '<img src="../../public/image/ajax-loading.gif" align="">',
...
// Override summernotes image manager
	...
	$(document).delegate('button[data-toggle=\'image\']', 'click', function() {
		...
		$.ajax({
			url: location.protocol+'//'+window.location.host+'/common/filemanager',
			dataType: 'html',
			/*
			beforeSend: function() {
