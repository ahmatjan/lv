    ...
    return {
        ...
        init: function () {
            ...
            $('#sample_2').dataTable({
                "aLengthMenu": [
                    [15, 20, 40, -1],
                    [15, 20, 40, "全部"] // change per page values here
                ],
            ...
            jQuery('#sample_4_wrapper .dataTables_length select').select2(); // initialzie select2 dropdown
          ...
          //-----------------------------------------------------------------------------
            ...
            jQuery('#sample_5_wrapper .dataTables_length select').select2(); // initialzie select2 dropdown
            ...
            jQuery('#sample_6_wrapper .dataTables_filter input').addClass("m-wrap small"); // modify table search input
            jQuery('#sample_6_wrapper .dataTables_length select').addClass("m-wrap small"); // modify table per page dropdown
            jQuery('#sample_6_wrapper .dataTables_length select').select2(); // initialzie select2 dropdown
          ...
          //-----------------------------------------------------------------------------
            ...
            jQuery('#sample_7_wrapper .dataTables_filter input').addClass("m-wrap small"); // modify table search input
            jQuery('#sample_7_wrapper .dataTables_length select').addClass("m-wrap small"); // modify table per page dropdown
            jQuery('#sample_7_wrapper .dataTables_length select').select2(); // initialzie select2 dropdown
