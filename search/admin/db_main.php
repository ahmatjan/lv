...
<table width="94%" border="0" cellspacing=0 cellpadding=0 align="center">
  <tr align=center> 
	...
	<td class="greyHeading"><b>数据表</b></font></td>
	<td width="10%" class="greyHeading"><b>记录行</b></font></td>
	<td width="20%" class="greyHeading"><b>创建时间</b></font></td>
	<td width="15%" class="greyHeading"><b>数据大小kB</b></font></td>
	<td width="17%" class="greyHeading"><b>索引大小kB</b></font></td>
  </tr>
 <?php
...
echo "
<tr><td colspan='6'>
<input type='checkbox' name='chg' onclick=\"checkAll(document.getElementById('dbform'),'check',this);\"><b>选中所有表</b>
</td></tr></table>
<center><input  id='submit' type='submit' name='send2' value='优化表'></center><br>
...
request was processed.</b>如果您没有收到屏幕上的任何错误，那么
你会发现，你的数据库表已经恢复。<br></td></tr></table>";
}
} 
if (isset($file) && $del==1) {
	@unlink($backup_path.$file);
...
<?php
	...
	while ($file = readdir ($dir)) { 
		if ($file != "." && $file != ".." &&  (eregi("\.sql",$file) || eregi("\.gz",$file))){
			if($is_first==1){
				echo "<tr> 
				<td width=\"30%\" align=\"center\" class=\"greyHeading\"><b>文件名</b></td>
				<td width=\"20%\" align=\"center\" class=\"greyHeading\"><b>大小</b></td>
				<td width=\"20%\" align=\"center\" class=\"greyHeading\"><b>日期</b></td>
