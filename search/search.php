...
//头部变量
$search_title=!empty(@$query)? @$query.'|旅行兔搜索':'旅行兔搜索';
...
if(empty($query) || !empty($catid)){
	...
	require_once("$template_dir/$template/search_formall.html");
}
...
function poweredby () {
    ...
    print $sph_messages['Powered by'];?>  <a href="http://www.lvxingto.com/"><img src="sphider-logo.png" border="0" style="vertical-align: middle" alt="Sphider"></a>
