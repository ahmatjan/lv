											...
											<div class="portlet box grey">
												...
												<div class="portlet-title">
													...
													<div class="actions">
														...
														<a href="<?php echo site_url('setting/layout_form?tab_position=tab_1_2')?>" class="btn blue"><i class="icon-pencil"></i>
											...
											<div class="portlet box grey">
												...
												<div class="portlet-title">
													...
													<div class="actions">
														...
														<a href="<?php echo site_url('setting/layout_form?tab_position=tab_1_3')?>" class="btn blue"><i class="icon-pencil"></i>
