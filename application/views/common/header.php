...
<link rel="shortcut icon" href="<?php echo base_url('public/image/favicon.ico')?>" />
	...
	<script src="<?php echo base_url('public/js/jquery-1.10.1.js')?>" type="text/javascript"></script>

	<script src="<?php echo base_url('public/js/jquery-migrate-1.2.1.js')?>" type="text/javascript"></script>

	<!-- IMPORTANT! Load jquery-ui-1.10.1.custom.min.js before bootstrap.min.js to fix bootstrap tooltip conflict with jquery ui tooltip -->

	<script src="<?php echo base_url('public/js/jquery-ui-1.10.1.custom.js')?>" type="text/javascript"></script>      
