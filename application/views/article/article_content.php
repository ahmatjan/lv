						...
						<div class="row-fluid">
							...
							<div class="article-block">
								...
								<div class="blog-tag-data">
									...
									<img src="<?php echo base_url('public/image/item_img.jpg')?>" alt="">
						...
						<div class="span12" style="margin-left: 0">
							...
							<div class="portlet">
								...
								<div class="portlet-title line">
									...
									<div class="caption"><i class="icon-comments"></i>评论交流区</div>
									...
									<!--<div class="scroller" data-height="435px" data-always-visible="1" data-rail-visible1="1">-->
										...
										<ul class="chats">
											...
											<li class="in">
												...
												<img class="avatar" alt="" src="<?php echo base_url('public/image/avatar1.jpg')?>" />
											...
											<li class="out">
												...
												<img class="avatar" alt="" src="<?php echo base_url('public/image/avatar2.jpg')?>" />
											...
											<li class="out">
												...
												<img class="avatar" alt="" src="<?php echo base_url('public/image/avatar3.jpg')?>" />
