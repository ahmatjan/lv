							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">
										<b><?php echo $username?>：你好!</b>
									</td>
								</tr>
								<tr>
									<td style="padding: 20px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
										这是一封来自【旅行兔网站】的邮件，你收到这封邮件是因为你提交了一个找回密码的申请，<a href="<?php echo site_url('user/login/edit_password?token='.$token)?>">修改密码请单击此处</a><br/><br/>如果不能打开链接，你可以把下页的链接复制到浏览器打开<br/><?php echo site_url('user/login/edit_password?token='.$token)?><br/><br/>如果不是你本人操作，请忽略！<br/>系统邮件，请勿回复！
									</td>
								</tr>
							</table>
						</td>
