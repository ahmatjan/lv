...
*/
		...
		*/
		...
		$te1 = '我字2sssseeeddf符串2sssseeeddf长度';
		
		//echo mb_strlen(mb_substr($te1,0,5), 'UTF-8');
		preg_match_all("/[\x{4e00}-\x{9fa5}]+/u", $te1, $chinese);//提取的中文字符串
		...
		echo join($china_);
		//提取非中文字符
		$te1 = preg_replace("/[\x{4e00}-\x{9fa5}]+/u",'',$te1);
		echo $te1;
		*/
